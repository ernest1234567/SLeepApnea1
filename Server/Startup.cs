...
namespace SLeepApnea.Server
{
	public class Startup
	{
		...
		{
			var connectionString = "server=192.168.43.153;user=root;database=sleepapnea;port=3307";
			//var connectionString = "server=localhost;user=root;database=sleepapnea;port=3307";
